...
- [smart-terminal-mcp](https://github.com/pungggi/smart-terminal-mcp): A Windows-native MCP server that gives AI agents real interactive terminal access via pseudo-terminals.
