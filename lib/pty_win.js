...
function Agent(file, args, env, cwd, cols, rows, debug) {
  ...
  this.ptySocket.setEncoding('utf8');
  this.ptySocket.connect(this.dataPipeOut, function () {
    // Emit ready event.
    self.ptySocket.emit('ready_datapipe');
  });
}
...
Terminal.prototype.write = function(data) {
  defer(this, function() {
    // TODO: I think this should send to in data pipe this.dataPipeIn.write(data);
